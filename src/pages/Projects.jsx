...
import inventory_v2 from '../static/images/inventory_v2.png'
...
const Projects = () => {
    return (
        <div className='container flex flex-col h-screen items-center'>
            ...
            <div className="mt-20 grid grid-cols-1 gap-10 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 flex-wrap pb-52">
                ...
                <Link to='https://inventory.vitaliisili.com' rel='noreferrer' target={'_blank'} className="transition-shadow duration-200 h-[30em] w-80 border-0 border-lg rounded-lg overflow-hidden relative hover:cursor-pointer hover:shadow-[-3px_10px_23px_0.36px_rgba(100,116,139,0.20)]">
                    <img className='h-full w-full object-cover' src={inventory_v2} alt="inventory"/>
                ...
                <Link to='https://protocloud.synology.me/' rel='noreferrer' target={'_blank'} className="transition-shadow duration-200 h-[30em] w-80 border-0 border-lg rounded-lg overflow-hidden relative hover:cursor-pointer hover:shadow-[-3px_10px_23px_0.36px_rgba(100,116,139,0.20)]">
                    <img className='h-full w-full object-cover' src={synology} alt="synology"/>
                    <div className="absolute flex w-full h-28 bottom-0 backdrop-blur-sm">
                        <p className='text-white my-auto ml-5 font-bold text-xl'>Synology Cloud</p>
                    </div>
                </Link>
